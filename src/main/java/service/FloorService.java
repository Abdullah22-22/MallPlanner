...
public class FloorService {
    ...
    public double profit( double rentedArea, double rentPrice,double floorArea, double costPerM2){

                double income = rentedArea * rentPrice;
                double cost = floorArea * costPerM2;
                return income - cost;
    }
